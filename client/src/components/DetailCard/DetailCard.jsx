...
import { parseDate, parseDateWithNoHours } from "../../constants/parseDateFn";
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:justify-start md:gap-20 gap-10">
      ...
      <div className="text-gray">
        ...
        <DetailDiv
          text="Nacimiento"
          value={parseDateWithNoHours(animal?.birthday)}
        />
            ...
            {animal?.is_pregnant ? (
              <>
                ...
                <DetailDiv
                  ...
                  value={parseDateWithNoHours(animal.delivery_date)}
                />
              </>
            ) : (
